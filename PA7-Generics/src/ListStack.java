 ...
 * in this code, where the class represents the Stack ADT. This was also meant
...
public class ListStack<E> implements StackInterface<E> {
     ...
     * see if the stack is empty, and then returns null if it
